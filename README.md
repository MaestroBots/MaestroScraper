...
| Platform                  | File                                                                                                                                        | Notes             |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| **Windows**               | [`maestro-scraper-1.4.0-x64.exe`](https://github.com/MaestroBots/MaestroScraper/releases/download/v1.4.0/maestro-scraper-1.4.0-x64.exe)     | Run the installer |
| **macOS (Apple Silicon)** | [`maestro-scraper-1.4.0-arm64.dmg`](https://github.com/MaestroBots/MaestroScraper/releases/download/v1.4.0/maestro-scraper-1.4.0-arm64.dmg) | M1/M2/M3/M4 Macs  |
| **macOS (Intel)**         | [`maestro-scraper-1.4.0-x64.dmg`](https://github.com/MaestroBots/MaestroScraper/releases/download/v1.4.0/maestro-scraper-1.4.0-x64.dmg)     | Older Intel Macs  |
| **Linux**                 | [`maestro-scraper-1.4.0-amd64.deb`](https://github.com/MaestroBots/MaestroScraper/releases/download/v1.4.0/maestro-scraper-1.4.0-amd64.deb) | Debian/Ubuntu     |
